...
client\+\_\+rp\+: to get a random goal at custom service Random\+Position goal\+\_\+position\+: the random goal generated as a Position\+Goal and send it to /go\+\_\+to\+\_\+point node service\+: read the command sent by the user from the Command service custom message
